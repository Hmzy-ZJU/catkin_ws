...
public:
    ...
    // Save all MapPoints as point cloud (PLY)
    void SaveMapPointsPLY(const std::string &filename, Map* pMap=nullptr, bool bOnlyGood=true);
    ...
    void RegisterEnhanceTime(double ms);      // 新增：由 ROS 前端调用
...
private:
    ...
    string mStrSavePointCloudToFile;   // <=== new: save point cloud (PLY)
