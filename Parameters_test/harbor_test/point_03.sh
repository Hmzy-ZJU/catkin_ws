...
# 8 套 YAML 所在目录
CONFIG_DIR="${CONFIG_DIR:-$WS/src/orb_slam3_ros/config/Monocular/Aquacular_harbor/point_1}"
# 8 套配置名字（必须与 .yaml 文件名对应）/home/hmzy/catkin_ws/src/orb_slam3_ros/config/Monocular/Aquacular_harbor/point_1/harbor_topk_40.yaml
CONFIG_NAMES=(
  "harbor_topk_65"
  "harbor_topk_75"
  "harbor_topk_85"
