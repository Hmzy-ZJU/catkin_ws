...
# 8 套 YAML 所在目录
CONFIG_DIR="${CONFIG_DIR:-$WS/src/orb_slam3_ros/config/Monocular/Aquacular_harbor/KF_2}"
# 8 套配置名字（必须与 .yaml 文件名对应）/home/hmzy/catkin_ws/src/orb_slam3_ros/config/Monocular/Aquacular_harbor/KF_1/harbor_AllowBitsDrop_1.yaml
CONFIG_NAMES=(
  "harbor_AllowBitsDrop_0.1"
  "harbor_AllowBitsDrop_0.2"
  "harbor_AllowBitsDrop_0.3" 
  "harbor_AllowBitsDrop_0.4"
  "harbor_AllowBitsDrop_0.5"
  
  "harbor_AllowBitsDrop_0.6" 
  "harbor_AllowBitsDrop_0.7"
  "harbor_AllowBitsDrop_0.8" 
  "harbor_AllowBitsDrop_0.9"
  "harbor_AllowBitsDrop_1.0"
  
  "harbor_AllowBitsDrop_1.1"
  "harbor_AllowBitsDrop_1.2"
  "harbor_AllowBitsDrop_1.3" 
  "harbor_AllowBitsDrop_1.4"
  "harbor_AllowBitsDrop_1.5"
  
  "harbor_AllowBitsDrop_1.6"
  "harbor_AllowBitsDrop_1.7"
  "harbor_AllowBitsDrop_1.8"
  "harbor_AllowBitsDrop_1.9"  
  "harbor_AllowBitsDrop_2.0"  
  
  "harbor_AllowBitsDrop_2.1"
  "harbor_AllowBitsDrop_2.2" 
  "harbor_AllowBitsDrop_2.3"
  "harbor_AllowBitsDrop_2.4"   
  "harbor_AllowBitsDrop_2.5" 
  
  "harbor_AllowBitsDrop_3.0"
  "harbor_AllowBitsDrop_3.5"  
  "harbor_AllowBitsDrop_4.0" 
