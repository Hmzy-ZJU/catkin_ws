...
# 8 套 YAML 所在目录
CONFIG_DIR="${CONFIG_DIR:-$WS/src/orb_slam3_ros/config/Monocular/Aquacular_harbor/enh_config_6}"
# 8 套配置名字（必须与 .yaml 文件名对应）/home/hmzy/catkin_ws/src/orb_slam3_ros/config/Monocular/Aquacular_harbor/enh_config/
CONFIG_NAMES=(
  "harbor_enh_2"
  "harbor_enh_3"
  "harbor_enh_4"
