...
- `aquaticvision_stereo.yaml`: AquaticVision stereo configuration. Current IDVO setting: `InfoSelector.TopK=150`, `InfoKF.AllowBitsDrop=2.3`, `InfoKF.MaxFramesForce=120`.
